...
export class XlsxBuilderService {
	private worksheetKeys: WorksheetKey[] = [
		...
		{ key: "waste.certificate", label: "Osvědčení", columnWidth: 10 },
		...
		{ key: "template.medicalCompany.companyId", label: "IČP/IČZ/IČOB provozovny", columnWidth: 15 },
		...
		{ key: "wasteCompany.companyId", label: "IČP/IČZ/IČOB partnera", columnWidth: 15 },
