...
export class initMigration1662808488514 implements MigrationInterface {
	...
	public async up(queryRunner: QueryRunner): Promise<void> {
		...
		await queryRunner.query(`ALTER TABLE "template_loading_code"
            ADD CONSTRAINT "FK_99e60e67216049b858b8bd1284b" FOREIGN KEY ("template_id") REFERENCES "template" ("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
		await queryRunner.query(`ALTER TABLE "template_loading_code"
		...
		await queryRunner.query(`ALTER TABLE "template_waste"
            ADD CONSTRAINT "FK_7baf2672eab376e79a8c6294729" FOREIGN KEY ("template_id") REFERENCES "template" ("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
		await queryRunner.query(`ALTER TABLE "template_waste"
